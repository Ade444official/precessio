...
giza: {
  ...
  { id:"sfinge", nome:"Sfinge", tipo:"sfinge", attivo:true,
    lat:29.97528, lon:31.13757,
    lunghezza:73, altezza:20, larghezza:19, azimut:90, orientamento:90,
    fonte:"pubblicato", rif:"lunghezza ~73 m, altezza ~20 m, larghezza ~19 m; asse E-O, fronte a est",
    nota:"RICOSTRUZIONE per SEZIONI: corpo continuo modellato lungo l asse E-O (groppa, fianco, spalla, petto), zampe protese con le dita, collo, volto e nemes con le bande. MISURATE le sole tre dimensioni d ingombro (73 x 19 x 20 m, fonte pubblicata); TUTTE le proporzioni interne sono stimate dalle fotografie e NON derivano da rilievo. Per una forma vera servirebbe una scansione fotogrammetrica con licenza verificata" },
...
saqqara: {
  nome: "Saqqara",
  centro: { lat: 29.8711, lon: 31.2164 },
  raggio: 0.05,
  elementi: [

  /* ATTENZIONE — nessuna di queste coordinate e' stata misurata da ADE 444.
     Sono valori di letteratura, utili solo come punto di partenza: vanno rimisurate
     con lo stesso metodo usato a Giza (4 spigoli su Google Earth Pro, media). */

  { id:"djoser", nome:"Piramide a gradoni di Djoser", tipo:"piramide", attivo:true,
    lat:29.871111, lon:31.216389,
    base:115, altezza:62.5,
    fonte:"pubblicato",
    rif:"coordinate e dimensioni di letteratura (base rettangolare 121x109 m, qui mediata a 115; altezza originaria 62,5 m su 6 gradoni)",
    nota:"la prima piramide della storia, III dinastia, architetto Imhotep. Base RETTANGOLARE, non quadrata: il nostro motore la disegna quadrata, quindi la pianta e' approssimata. DA RIMISURARE" },

  { id:"userkaf", nome:"Piramide di Userkaf", tipo:"piramide", attivo:true,
    lat:29.874700, lon:31.218300,
    base:73.3, altezza:49,
    fonte:"approssimato",
    rif:"coordinate approssimate da letteratura divulgativa, NON verificate su rilievo",
    nota:"V dinastia. Coordinate da rimisurare prima di qualunque uso in calcoli di allineamento" },

  { id:"unas", nome:"Piramide di Unas", tipo:"piramide", attivo:true,
    lat:29.868600, lon:31.214400,
    base:57.75, altezza:43,
    fonte:"approssimato",
    rif:"coordinate approssimate da letteratura divulgativa, NON verificate su rilievo",
    nota:"V dinastia, prima piramide con i Testi delle Piramidi. DA RIMISURARE" },

  { id:"teti", nome:"Piramide di Teti", tipo:"piramide", attivo:true,
    lat:29.875600, lon:31.221700,
    base:78.5, altezza:52.5,
    fonte:"approssimato",
    rif:"coordinate approssimate da letteratura divulgativa, NON verificate su rilievo",
    nota:"VI dinastia. DA RIMISURARE" },

  { id:"sekhemkhet", nome:"Piramide sepolta (Sekhemkhet)", tipo:"marcatore", attivo:true,
    lat:29.868100, lon:31.211700,
    raggio:60, altezza:8,
    fonte:"approssimato",
    rif:"coordinate approssimate; struttura incompiuta e in gran parte sepolta",
    nota:"segnata come marcatore e non come piramide perche' non ha una forma emergente definita. DA RIMISURARE" }

  ],
  osservatori: [
    { nome:"veduta est di Djoser", lat:29.871100, lon:31.220500 },
    { nome:"veduta sud (verso Unas)", lat:29.865000, lon:31.216000 },
    { nome:"veduta nord (verso Teti)", lat:29.880000, lon:31.219000 }
  ]
},
